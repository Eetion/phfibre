...
// number of facets (binned by dimension): [0, 0, 0, 12]
// number of polytopes (total): 85
// number of polytopes (binned by dimension): [10, 30, 33, 12]
// number of pairs of intersecting facets, binned by the dimension of the intersection polytope: [27, 24, 15, 0]
// betti numbers: [1, 0, 0, 0]
// betti numbers (via nerve dowker): [1, 0, 0, 0]