//  DESCRIPTION
// Simplicial CYLINDER. BOTH SOME GENERAL FILTERS AND LOWER STARS
// HOMOLOGY OF CYLINDER IS H_0=Q, H_1=Q and H_n=0 for n>0. SO IN THE ASSOCIATED BARCODE THERE IS JUST 2 INFINITE BAR. If not true we need to modify infinite bars in barcodes below
...
fn main() {
  ...
  let save_dir_opt        = None;
    ...
    println!("\n  HOMOLOGY OF CYLINDER IS Q in degree 0 and 1, and null for higher degrees. SO IN THE ASSOCIATED BARCODE THERE IS JUST 2 INFINITE BARS. If not true we need to modify infinite bars in barcodes below");
    //  ----------------------------------------------------------------------------------------------
    ...
    // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH NO FINITE BARS------------

    //  Define the base space, barcode, and ring
    println!("\n SIMPLICIAL CYLINDER, BARCODE WITH NO FINITE BARS");
    println!("===============================================================================================\n");
    let complex_facets      =   vec![     vec![0,1,2],vec![0,2,3],  vec![2,3,4],vec![2,4,5], vec![0,4,5],vec![0,1,5]];
    ...
    */
    ...
    // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH ONE FINITE BAR ------------
    ...
    */
    ...
    // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH TWO DISJOINT FINITE BARS ------------
...
*/
    ...
    &   poly_complex_facets,
        ...
        // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH TWO OVERLAPPING FINITE BARS ------------
...
*/
    ...
    &   poly_complex_facets,
        ...
        // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH 1 FINITE BAR IN ANOTHER ------------
...
*/
    ...
    &   poly_complex_facets,
        ...
        save_dir_opt,
         ...
         // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH 3 DISJOINT FINITE BARS------------
    ...
    &   poly_complex_facets,
     ...
     // -------------------- SIMPLICIAL CYLINDER, BARCODE WITH 3 CONSECUTIVE TOUCHING FINITE BARS------------
