...
//  FUTURE IMPROVEMENT: 
//      - I DON'T THINK WE COULD TERMINATE CONSTRUCTION AFTER LAST CRITICAL CLASS (EVEN THOUGH WE WILL HAVE ALREADY CHECKED THAT )
//      - PERRHAPS THERE'S SOMETHIG WE COULD DO TO COMPUTE VERTICES FASTER
